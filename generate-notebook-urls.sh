...
echo "        https://colab.research.google.com/github/projectnessie/nessie-demos/blob/${GIT_REF}/${REL_FILEPATH}"
echo ""
echo "Binder URL (mybinder.org):"
echo "        https://mybinder.org/v2/gh/projectnessie/nessie-demos/${GIT_REF}?filepath=${FILEPATH_PARAM}"
