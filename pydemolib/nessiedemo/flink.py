...
class NessieDemoFlink:
    ...
    def table_env_for_ref(self: T, nessie_ref: str, catalog_name: str = "nessie") -> StreamTableEnvironment:
        ...
        table_env.execute_sql(f"CREATE CATALOG {catalog_name} "
                              f"WITH ('type'='iceberg', 'catalog-impl' = "
                              f"'org.apache.iceberg.nessie.NessieCatalog', "
